          ...
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }} data-reveal="fade-up" data-delay="400">
              <div style={{ display: 'flex', gap: '0.875rem', alignItems: 'center' }}>
                <span style={{ fontSize: '1.25rem' }}><Phone size={18} /></span>
                <div>
              ...
              <div style={{ display: 'flex', gap: '0.875rem', alignItems: 'center' }}>
                <span style={{ fontSize: '1.25rem' }}><MessageCircle size={18} /></span>
                <div>
              ...
              <div style={{ display: 'flex', gap: '0.875rem', alignItems: 'center' }}>
                <span style={{ fontSize: '1.25rem' }}><Mail size={18} /></span>
                <div>
              ...
              <div style={{ display: 'flex', gap: '0.875rem', alignItems: 'flex-start' }}>
                <span style={{ fontSize: '1.25rem' }}><MapPin size={18} /></span>
                <div>
          ...
          <div data-reveal="fade-left" data-delay="200">
            {submitted ? (
              <div style={{ background: 'var(--color-gray-50)', padding: '2.5rem', borderRadius: 'var(--radius-lg)', border: '1px solid var(--color-gray-200)', textAlign: 'center' }}>
                <div style={{ fontSize: '3rem', marginBottom: '1rem' }}><CheckCircle size={48} color='var(--color-primary)' /></div>
